...
const Signup = (props) => {
  ...
  const formSubmit = async () => {
    ...
    try {
      //post{return AxiosResponse{  data: T;status:n;statusText:s;headers:any;config:AxiosRequestConfig;request?:any;}}
      //retrun res/axios.post/.data catch(e){console.log()}
    ...
    <Fragment>
      ...
      <form className="space-y-4">
        ...
        <div className="flex flex-col">
          <label htmlFor="name">
            Name<div className="text-sm text-gray-600 ml-1">*</div>
          </label>
          <input
            onChange={(e) =>
              setData({...data,success: false,error: {},
                name: e.target.value,
              })}
            value={data.name}
            type="text"
